...
<body>
    ...
    <main id="signup">
        ...
        <section id="option">
            <div class="tab" id = "vendor-tab" onclick="seeMore(this)">
                <h2>Vendor</h2>
                <img src="assets/image/signupimage/handshake.png" alt="icon" class="tab-img">
                <ul class="tab-main-content">
                    <li>
            ...
            <div class="tab"  id="customer-tab" onclick="seeMore(this)">
                <h2>Customer</h2>
            ...
            <div class="tab" id="shipper-tab" onclick="seeMore(this)">
                <h2>Shipper</h2>
